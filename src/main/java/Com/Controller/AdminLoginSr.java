...
/**
 * Servlet implementation class AdminLoginSr
 */
@WebServlet("/AdminLoginSr")
public class AdminLoginSr extends HttpServlet {
	...
	protected void doPost(HttpServletRequest request, HttpServletResponse response) throws ServletException, IOException {
		...
		try
		{
			...
			String S = P.LoginCheck(email, password);
			if(S!= null)
			{
				HttpSession session = request.getSession();
				session.setAttribute("ad", S);
